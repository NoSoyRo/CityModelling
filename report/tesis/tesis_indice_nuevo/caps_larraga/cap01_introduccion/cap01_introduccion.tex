...
suelo y calidad de vida. Esos impactos están documentados en frentes distintos. La
...
país \parencite{CONABIO2024Porque}. El transporte terrestre que la dispersión vuelve
necesario tiene externalidades negativas documentadas para el caso
...
conecta mediante flujos de recursos \parencite{Seto2012teleconnections}.
...
sostenida \parencite{CONAPO2018Delimitacion,INEGI2020Censo}. Este patrón, descrito para
Querétaro en relación con la producción de
vivienda \parencite{ObservatorioCiudades2022Queretaro} pero no suficientemente modelado
para la ZMQ,
