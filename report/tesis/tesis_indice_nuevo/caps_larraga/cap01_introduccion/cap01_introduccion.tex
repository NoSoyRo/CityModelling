...
Este patrón obervado, que por cierto no ha sido suficientemente modelado para la ZMQ, impide claramente anticipar donde y a qué velocidad se producirá la siguiente oleada de expansión: información que es sumamente importancia si se desean planear usos de recursos para la creación de la infraestructura necesaria para el crecimiento urbano.
