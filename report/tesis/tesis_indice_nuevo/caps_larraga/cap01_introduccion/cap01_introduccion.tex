...
En el mundo, la sobrepoblación representa un problema severo en términos de recursos, competencia y calidad de vida. La ciencia ha intentado abordar el problema con diferentes estrategias, por ejemplo el uso de modelos de inteligencia artificial para predecir el volumen de población en el futuro; sin embargo, estos modelos son muy costosos y no auditables, y nunca se sabe qué están aprendiendo realmente. Se han intentado vías de modelado por medio de ecuaciones diferenciales, pero hacerlos requiere de una capacidad muy grande de poder abstraer matemáticamente relaciones y entidades, lo cual no es del todo trivial. De modo que la ciencia ha estado buscando estrategias que permitan modelar el crecimiento urbano de manera más eficiente y precisa; dentro de ellas existe el subcampo de las ciencias de la computación que adopta estrategias de autómatas celulares, que permiten mantener una precisión estable así como la capacidad de auditar cada decisión tomada al hacer una predicción. 

Los medios existen y han sido parte del desarrollo de la misma ciencia del urbanismo; sin embargo, obtener datos (hasta hace unos años) ha sido uno de los más grandes retos, así como la capacidad de cómputo para procesarlos. Si se desea realizar predicciones precisas y sostenibles que sean auditables, se tiene que asegurar que los datos sean suficientes y alcanzables.

Google Earth, en su aplicación de escritorio, ofrece una herramienta que permite viajar en el tiempo para observar una vista satelital de una zona geográfica. Esas capturas muestran cómo ha cambiado una ciudad año con año. Estas capturas no son mapas de algún tipo: son imágenes en formato JPG que requieren ser traducidas a zona urbana/no urbana.
...
Predecir el crecimiento urbano es necesario, pues impacta en la posibilidad de asegurar que el ser humano viva en condiciones adecuadas de vivienda y con los servicios necesarios para su existencia. Como ya se ha mencionado, se han creado diferentes tipos de modelos para predecir este cambio de uso de suelo; entre ellos se encuentran los autómatas celulares, como uno de los principales exponentes en este terreno.  
