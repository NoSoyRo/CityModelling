...
\begin{figure}[htbp]
  ...
  \caption{Ejemplo del cálculo de WoE: la variable \textit{distancia al frente urbano} acumula pesos positivos en bins próximos y negativos en bins lejanos. La suma ponderada pasa por la sigmoide y se compara con $\theta=0{,}75$.. \textit{Imagen elaborada con IA generativa.}}
