...
Un \textbf{Autómata Celular} (AC) es un sistema dinámico discreto definido sobre una cuadrícula regular de $N$ celdas. Formalmente, un AC queda definido por la cuádrupla $(Q, \mathcal{N}, \delta, q_0)$, donde:
