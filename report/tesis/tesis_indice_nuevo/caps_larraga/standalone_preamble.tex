...
% babel-spanish rotula los flotantes como «Cuadro»; el cuerpo del texto los
% llama «Tabla» en los 34 reenvíos, así que se unifica el rótulo.
...
\hypersetup{
    ...
    pdfborder={0 0 0},
    pdftitle={Modelado del crecimiento urbano en la Zona Metropolitana de Querétaro mediante Weight of Evidence y Autómatas Celulares},
    pdfauthor={José Rodrigo Moreno López},
    pdfsubject={Tesis de Maestría -- Autómatas Celulares y Pesos de Evidencia},
	pdfkeywords={AutomatasCelulares,WeightOfEvidence,CrecimientoUrbano,Queretaro,ValidacionMultitemporal}
}
