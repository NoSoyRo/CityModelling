...
Hoy en dia el sotware libre ha demostrado contundentemente que es la mejor forma de construir modelos reproducibles y transferibles. Una fracción significativa de los modelos LUCC más citados depende de software
propietario. Por ejemplo, dinamica EGO opera bajo licencia académica restringida; IDRISI y
TerrSet son comerciales; SLEUTH funciona con un código en C disponible pero
cuya instalación en sistemas modernos requiere ajustes no documentados, aun cuando la Inteligencia Artificial podria ayudar en este aspecto no es trivial y requiere de un gran esfuerzo de parte del usuario. La
...
cero o dedicar un esfurzo importrante descifrando requerimientos no documentados. El presente trabajo opta por esta vía: se implementa íntegramente en
...
campo WoE ponderado por IV y la influencia del vecindario con decaimiento por
distancia deciden conjuntamente cuántas y cuáles celdas transitan. El esquema de
