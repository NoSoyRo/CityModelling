...
\textbf{H3 (apoyada por la evidencia).} El procesamiento completo, a partir de las capturas, se ejecutó en Python (NumPy, SciPy, scikit-learn) en escritorio, sin GPU ni software propietario, en un cómputo del orden de tres horas en CPU estándar. La obtención de las capturas sí requiere el visor de Google Earth, que no es de código abierto.

\textbf{H4 (apoyada por la evidencia).} El FoM promedio de $0{,}317$ se ubica en la banda intermedia del espectro multi-sitio de \textcite{pontius2008comparing}, en los términos precisados en la Sección~\ref{sec:evaluacion}. Ese estudio no reporta Kappa, y su FoM es ya una intersección sobre unión restringida a las celdas de cambio, distinta del IoU sobre el estado urbano final que aquí se mide. El Kappa de $0{,}445$ se interpreta entonces frente a la escala de \textcite{LandisKoch1977}, y el IoU de $0{,}633$ mide qué fracción de la unión entre lo urbano observado y lo urbano predicho en el año final coincide. El contraste con modelos de caja negra es cualitativo: sitios, clases y horizontes distintos.
