...
\begin{figure}[htbp]
  ...
  \caption{Desempeño comparado del modelo WoE-AC en las cinco ventanas quinquenales. Las líneas verticales punteadas señalan el promedio de cada métrica: FoM $=0{,}317$, Kappa $=0{,}445$, IoU $=0{,}633$. La estabilidad entre ventanas indica que el modelo captura una dinámica estructural del crecimiento y no un patrón sobreajustado.}
