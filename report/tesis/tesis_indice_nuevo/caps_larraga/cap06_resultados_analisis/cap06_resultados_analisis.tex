...
Antes de presentar los resultados de la simulación conviene situarlos en el contexto histórico del crecimiento urbano de Querétaro. La inspección de la serie temporal de 37 años permite identificar cuatro períodos diferenciados:
...
El pipeline de clasificación no supervisada (K-Means + SVM) reporta una exactitud interna de 88--94\% en el conjunto de prueba holdout (20\% de los píxeles), según se describe en el Capítulo~\ref{ch:modelo-crecimiento-urbano}. Con una imagen de 5.4 millones de píxeles, incluso un 5--10\% de error equivale a 270{,}000--540{,}000 píxeles mal clasificados por imagen. Estos errores se manifiestan como confusión espectral (suelo desnudo o techos claros clasificados como urbano) e inconsistencias temporales que introducen ``transiciones'' espurias en el historial WoE.
